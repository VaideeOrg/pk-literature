...
// to run this way through RDS Proxy, but feed_api_rw's own pg_hba.conf
// rule (like every other Lambda service's role here) now requires
// plain password auth instead — RDS Proxy's IAM auth for these roles
// was tried two ways for real and abandoned; see
