...
# Flipped back to true: gating the storefront again while inventory/
# cover-image issues (empty covers, out-of-stock inventory on newly
# promoted books) get sorted out - see variables.tf.
